...
IMAGE_NAME="calculadora-yaman"
SERVICE_NAME="calculadora-yaman-api"

TAG="${1:-}"
if [[ -z "$TAG" ]]; then
  echo "Uso: ./deploy-api.sh 2.0.0"
  exit 1
fi

cd "/Users/felipeclemente/Documents/workspace/calculadora-yaman"
